<h1 style="margin: 0px !important; font-size: 22px !important; color: #002f56 !important; font-family: 'Avenir-book' !important;">{{trans('pages.LE-TtESoliCot')}}</h1>
<br>
...
<h3 style="margin: 0px !important; font-size: 18px !important; color: #007298 !important; font-family: 'Avenir-book' !important;">{{trans('pages.LE-EExa')}}</h3> 
    ...
    @foreach($exames as $exame)
        <?php $aux = explode('#', $exame); ?>

        <li style="margin: 0px !important; width: 98% !important;">{{$aux[0]}} <span style="color:#002f56 !important; font-weight:bold !important;">[{{trans('pages.LE-EQtde')}} </span><span style="color:#999a9a !important;">{{$aux[1]}}]</span></li>
    @endforeach
    </ul>
<br>
